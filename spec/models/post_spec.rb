...
RSpec.describe Post, type: :model do
  ...
  describe "attributes" do
    it "has a title, body, and user attribute" do
      expect(post).to have_attributes(title: title, body: body, user: user) #Tests whether post.title and post.body will return a non-nil value when called.
    end
  end
